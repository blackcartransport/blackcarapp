...
class FinishProfileWidget extends StatefulWidget {
  const FinishProfileWidget({Key? key}) : super(key: key);

  @override
  _FinishProfileWidgetState createState() => _FinishProfileWidgetState();
}

class _FinishProfileWidgetState extends State<FinishProfileWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'finish_profile'});
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'FINISH_PROFILE_Image_1z82u5i6_ON_TAP');
                                                  logFirebaseEvent(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'FINISH_PROFILE_PAGE_Button-Login_ON_TAP');
                                                  logFirebaseEvent(
