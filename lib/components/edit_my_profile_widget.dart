...
class _EditMyProfileWidgetState extends State<EditMyProfileWidget> {
  ...
  void initState() {
    ...
    homeAddressController = TextEditingController(
        text: valueOrDefault(currentUserDocument?.userAddress, ''));
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'EDIT_MY_PROFILE_Icon_xox4ny2d_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: Text(
                          'use the form bellow to fill your user profile',
                                ...
                                Container(
                                  ...
                                  child: AuthUserStreamWidget(
                                    child: InkWell(
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EDIT_MY_PROFILE_Image_06p7j85p_ON_TAP');
                                        logFirebaseEvent(
                          ...
                          children: [
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'EDIT_MY_PROFILE_COMP_Button-Login_ON_TAP');
                                  logFirebaseEvent(
                                  ...
                                  final usersUpdateData = createUsersRecordData(
                                    ...
                                    userAddress: homeAddressController!.text,
                                  );
                                  await currentUserReference!
                                      .update(usersUpdateData);
                                  logFirebaseEvent('Button-Login_Bottom-Sheet');
                                  Navigator.pop(context);
                                },
                                text: 'Done',
